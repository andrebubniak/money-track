...
/**
 * In-shell loading state for the create-transaction form. Mirrors
 * `new/page.tsx`: back link, heading, then `TransactionForm`'s grid — type,
 * amount, and date on the first row, category and card on the second,
 * description and paid on the third — and its full-width submit button. See
 * `.claude/rules/navigation-loading.md`.
 */
export default async function NewTransactionLoading() {
