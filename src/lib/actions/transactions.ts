...
export async function updateTransaction(
  ...
  // `deactivatedAt: null` excludes a soft-deleted row — without it, a
  // forged or replayed request could still write to a transaction the user
  // already deleted. Installment occurrences generated by a recurrence are
  // always live (`deactivatedAt: null`) when this action is the one editing
  // them, so the guard doesn't affect that path.
