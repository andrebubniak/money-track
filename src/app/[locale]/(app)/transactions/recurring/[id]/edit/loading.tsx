...
/**
 * In-shell loading state for the edit-recurring-transaction form — the same
 * shape as `recurring/new/loading.tsx` under a shorter heading, per
 * `.claude/rules/navigation-loading.md`.
 */
export default async function EditRecurringTransactionLoading() {
