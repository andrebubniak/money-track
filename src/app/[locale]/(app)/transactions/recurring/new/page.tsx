  ...
  return (
    <main className="flex flex-1 flex-col gap-6 p-4 md:p-6">
      <div className="flex flex-col gap-2">
        ...
        <h1 className="text-2xl font-semibold tracking-tight">{t("recurring.newTitle")}</h1>
      </div>

      {/* No max-width: RecurringTransactionForm's own grid decides how much
          of the row each field takes at each breakpoint — see
          `.claude/rules/ui.md`. */}
